...
const InvestingBasics = () => {
    return (
        <React.Fragment>
            ...
            <div className="card-one">
                <div className="card-one-content">
                    <Col push="m1" s={12} m={6}>
                        <div class="card-title-left">Step 1: Learn</div>
            ...
            <div className="card-one">
                <div className="card-one-content">
                    <Col push="m1" s={12} m={6}><div class="card-title-left">Step 2: Open an account</div>
            ...
            <div className="card-one">
                <div className="card-one-content">
                    <Col push="m1" s={12} m={6}><div class="card-title-left">Step 3: Research stocks</div>
            ...
            <div className="card-one">
                <div className="card-one-content">
                    <Col push="m1" s={12} m={6}><div class="card-title-left">Step 4: Fund your account & buy stocks</div>
            ...
            <div className="card-one">
                <div className="card-one-content">
                    <Col push="m1" s={12} m={6}><div class="card-title-left">Step 5: Review your investments regularly</div>
